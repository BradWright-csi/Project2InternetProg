...
<head>
    ...
    <title>Make A Quotes | Preston Custom Designs</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    ...
    <div class=container>
        ...
        <form action="./quoteHandler.php" method="POST" id="services" name="services" onsubmit="return validate(this)">
        ...
        <script type="text/javascript" src="./js/validatequote.js"></script>
